...
public class MapManager {
	...
	public void initScenes() {
		allMaps = new ArrayList<GameMap>(4);
//		allMaps.add(Maps.map1);
		allMaps.add(Maps.map2);
		allMaps.add(Maps.map3);
		allMaps.add(Maps.mapend);
		...
		Tank enemy4 = TankFactory.buildTank(TankType.SUPER_TANK, 100, 16, 4, true);
		sce.addTank(main);
		sce.addTank(enemy2);
		sce.addTank(enemy3);
		sce.addTank(enemy4);
